...
namespace StoneMod
{
    ...
    public class StoneMod : NeosMod
    {
        public override string Name => "StoneMod";
        ...
        class StatueSystemWizard
        {
            ...
            Slot GetSlotThing(Slot x)
            {
                ...
                string file = x.Engine.AssetManager.RequestGather(fileUri, FrooxEngine.Priority.Urgent).GetAwaiter().GetResult();
